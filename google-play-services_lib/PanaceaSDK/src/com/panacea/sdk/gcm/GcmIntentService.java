	...
	protected void onHandleIntent(Intent intent)
	{
		...
		{ // has effect of unparcelling Bundle
			...
			else if (GoogleCloudMessaging.MESSAGE_TYPE_MESSAGE.equals(messageType))
			{
				...
				PMWebServiceController.device_push_outbound_messages_list(getApplicationContext(),
					PMDatabaseCipherHelper.getInstance(getApplicationContext())
						.getLastReceivedMessageId(), null, null, 20, null, null, null);
			}
		}
